<div class="min-h-screen bg-zinc-50 py-10">
    <div class="mx-auto max-w-3xl rounded-3xl border border-zinc-200 bg-white p-8 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
        <h1 class="text-2xl font-semibold text-zinc-950 dark:text-white">Buat Tenant Baru</h1>
        <p class="mt-2 text-sm text-zinc-500 dark:text-zinc-400">Isi detail untuk membuat bank sampah baru.</p>
        ...
        <form wire:submit.prevent="submit" class="mt-8 space-y-6">
            ...
            <div class="flex justify-end">
                <button type="submit" class="inline-flex items-center rounded-full bg-emerald-600 px-6 py-3 text-sm font-semibold text-white hover:bg-emerald-500">Buat Tenant</button>
            </div>
        </form>
    </div>
</div>
